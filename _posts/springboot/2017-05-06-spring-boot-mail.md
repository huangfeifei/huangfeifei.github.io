...
<html lang="zh" xmlns:th="http://www.thymeleaf.org">
    ...
    <body>
        ...
        <a href="#" th:href="@{ https://huangfeifei.github.io/neo/{id}(id=${id}) }">激活账号</a>
    </body>
</html>
```
...
可以参考前期文章：[Spring Boot(八)：RabbitMQ 详解](https://huangfeifei.github.io/springboot/2016/11/30/spring-boot-rabbitMQ.html) 来实现。

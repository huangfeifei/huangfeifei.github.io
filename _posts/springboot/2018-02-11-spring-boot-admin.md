...
上一篇文章[《Spring Boot(十九)：使用 Spring Boot Actuator 监控应用》](https://huangfeifei.github.io/springboot/2018/02/06/spring-boot-actuator.html)介绍了 Spring Boot Actuator 的使用，Spring Boot Actuator 提供了对单个 Spring Boot 的监控，信息包含：应用状态、内存、线程、堆栈等等，比较全面的监控了 Spring Boot 应用的整个生命周期。
...
![](https://huangfeifei.github.io/assets/images/2018/springboot/admin21.png)
...
![](https://huangfeifei.github.io/assets/images/2018/springboot/admin22.png)

页面会展示被监控的服务列表，点击详项目名称会进入此应用的详细监控信息。

![](https://huangfeifei.github.io/assets/images/2018/springboot/admin23.png)

...
Hibernate 特点就是所有的 Sql 都用 Java 代码来生成，不用跳出程序去写（看） Sql ，有着编程的完整性，发展到最顶端就是 Spring Data Jpa 这种模式了，基本上根据方法名就可以生成对应的 Sql 了，有不太了解的可以看我的上篇文章[Spring Boot(五)： Spring Data Jpa 的使用](https://huangfeifei.github.io/springboot/2016/08/20/spring-boot-jpa.html)。

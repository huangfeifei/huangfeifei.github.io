...
- [Docker(一)：Docker入门教程](https://huangfeifei.github.io/docker/2018/03/07/docker-introduction.html)
- [Docker(四)：Docker 三剑客之 Docker Compose](https://huangfeifei.github.io/docker/2018/03/22/docker-compose.html)

**Docker 化改造**

项目改造后的项目机构图如下：

![](https://huangfeifei.github.io/assets/images/2018/springboot/favorites_mulu.png)

因为上一篇文章[Spring Boot 2.0(五)：Docker Compose + Spring Boot + Nginx + Mysql 实践](https://huangfeifei.github.io/springboot/2018/03/28/dockercompose-springboot-mysql-nginx.html) 已经介绍了此类项目结构和内容含义，因此这里主要描述新增内容。

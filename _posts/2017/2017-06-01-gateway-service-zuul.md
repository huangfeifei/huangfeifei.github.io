...
#这里的配置表示，访问/it/** 直接重定向到https://huangfeifei.github.io/**
zuul.routes.baidu.path=/it/**
zuul.routes.baidu.url=https://huangfeifei.github.io/
```
...
启动```gateway-service-zuul-simple```项目，在浏览器中访问：```http://localhost:8888/it/spring-cloud```，看到页面返回了：```https://huangfeifei.github.io/spring-cloud ``` 页面的信息，如下：
...
-------------
**作者：纯洁大犊**  
**出处：[https://huangfeifei.github.io/](https://huangfeifei.github.io/springcloud/2017/06/01/gateway-service-zuul.html)**      
**版权归作者所有，转载请注明出处** 

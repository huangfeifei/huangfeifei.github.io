...
![](https://huangfeifei.github.io/assets/images/2017/life/router.jpg)  
...
为了尽可能的模拟生产，我在测试环境1:1搭建了一套和生产一样的FastDFS集群，当时也写了搭建过程：[FastDFS 集群 安装 配置](https://huangfeifei.github.io/fastdfs/2017/10/10/cluster-building-fastdfs.html)

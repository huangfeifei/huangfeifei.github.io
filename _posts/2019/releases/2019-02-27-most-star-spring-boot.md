...
2016年，在一次技术调研的过程中认识到了 Spring Boot ，试用之后便一发不可收拾的爱上它。为了防止学习之后忘记，就在网上连载了 [Spring Boot 系列文章](https://huangfeifei.github.io/spring-boot.html)，没想到这一开始便与 Spring Boot 深度结缘。
...
![](https://huangfeifei.github.io/assets/images/2019/springboot/springbootfun.png)
